...
object ResepData {
    private val data = arrayOf(
        ...
        arrayOf(
            "Nasi Uduk",
            "selerasa.com",
            "Sajikan dan nikmati lezatnya resep nasi sebagai menu bahan utama dari hidangan kali ini.",
            "- 600gr beras \n- 2 1/2 Sendok teh garam \n- 3 Batang serai \n- Santan dari 1 butir kelapa \n- 30 Lembar daun jeruk, buang tulang daunnya & iris tipis \n- 4 Lembar daun pandan \n- 24 Lembar daun salam \n- Bawang merah goreng untuk tabugan",
            "1. Untuk membuat hidangan nasi uduk kali ini anda akan dapat melakukannya dengan terlebih dahulu mendidihkan santan didalam sebuah panci. Lalu letakkan diatas kompor dengan menggunakan api yang sedang. \n2. Kemudian masukkan kedalamnya garam bersama dengan serai, daun pandan dan juga daun jeruk. Aduk-aduk semua bahan ini secara merata sampai tercampur. \n3. Selanjutnya baru anda bisa memasukkan beras kedalamnya dan aduk sampai santan meresap kedalamnya. Lalu sisihkan sajian ini dengan merata. \n4. Kemudian panaskan kukusan diatas api yang sedang dan tunggu sampai panas. Baru anda bisa masukkan beras yang sudah dimasak setengah matang kedalamnya. \n5. Kukus beras selama kurang lebih 30 menit sampai matang dan merata. Mnejelang diangkat anda akan dapat memasukkan daun jeruk kedalamnya. \n6. Nah, setelah sajian ini matang maka anda akan dapat menyajikannya diatas piring bersama lauk tambahan seperti ayam goreng. Hidangan ini akan dapat anda jadikan sebagai santapan untuk sarapan dan dinikmati bersama dengan kerupuk, sambal dan lalaban yang enak dan segar.",
        ...
        arrayOf(
            "Cumi Asin Pete",
            "resepmasakan.id",
            "Jenis makanan yang satu ini tidak hanya nikmat dimulut tapi juga sangat sarat dengan kandungan gizi yang tinggi",
            "- 200 gr cumi asin \n- 1 papan pete belah menjadi 2 biji \n- 10 bh cabe ijo potong serong \n- 3 buah cabe merah potong serong \n- 5 buah rawit merah potong serong \n- 5 buah rawit hijau potong serong \n- 5 buah bawang merah iris tipis \n- 3 buah bawang putih iris tipis \n- 1/2 buah bawang bombay \n- Sedikit tomat iris \n- 1 ruas lengkoas keprek \n- Sedikit jahe keprek \n- 2 lembar daun salam \n- 2 lembar daun jeruk \n- 1 buah sereh kecil keprek \n- 1 sendok makan kecap manis \n- 1 sendok makan saos tiram \n- Sedikit garam dan kaldu ayam bubuk \n- 50 ml air \n- Minyak goreng secukupnya",
            "1. Didihkan air ksh garam dikit lalu masukan cumi asin yang sudah di cuci bersih sampai cumi tersebut mengembang angkat dan tiriskan \n2. Potong-potong cumi dan Buang tulang putih cumi sm isi perutnya goreng betar tiriskan \n3. Panaskan minyak goreng lalu tumis bawang merah dan bawang putih sampai harum lalu masukan cabe2an, tomat,daun salam, daun jeruk, sereh,jahe dan lengkoas aduk sampai layu \n4. Lalu masukan cumi, pete dan bawang bombay aduk bentar lalu masukan kecap manis, saos tiram, sedikit garam, sedikit bubuk kaldu ayam dan air aduk dan diamkan sebentar \n5. Aduk lagi lalu tes rasa kalau sudah ok semua angkat dan sajikan",
            "https://resepmasakan.id/wp-content/uploads/2019/01/Resep-Cumi-Asin-Pete.jpg"
        ),
        arrayOf(
            "Mie Rebus Minang",
            "www.masakapahariini.com",
            "Kekhasan Mie Rebus Minang adalah kuah berwarna merah berkat kehadiran cabai ulek dan kuah kaldu tulang sumsum sapi.",
